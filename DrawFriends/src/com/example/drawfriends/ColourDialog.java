...
public class ColourDialog {
	public interface OnColourListener {
		void onCancel(ColourDialog dialog);
		void onOk(ColourDialog dialog, int color);
	}

	final AlertDialog dialog;
	final OnColourListener listener;
	final View viewHue;
	final ColourView viewSatVal;
	...
	/**
	 * create an ColourActivity. call this only from OnCreateDialog() or from a background thread.
	 * 
	 * @param context
	 *            current context
	 * @param color
	 *            current color
	 * @param listener
	 *            an OnColourListener, allowing you to get back error or
	 */
	public ColourDialog(final Context context, int color, OnColourListener listener) {
		this.listener = listener;
		Color.colorToHSV(color, currentColorHsv);

		final View view = LayoutInflater.from(context).inflate(R.layout.ambilwarna_dialog, null);
		viewHue = view.findViewById(R.id.ambilwarna_viewHue);
		viewSatVal = (ColourView) view.findViewById(R.id.ambilwarna_viewSatBri);
		...
		dialog = new AlertDialog.Builder(context)
			.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
				@Override public void onClick(DialogInterface dialog, int which) {
					if (ColourDialog.this.listener != null) {
						ColourDialog.this.listener.onOk(ColourDialog.this, getColor());
					}
				}
			})
			.setNegativeButton(android.R.string.cancel, new DialogInterface.OnClickListener() {
				@Override public void onClick(DialogInterface dialog, int which) {
					if (ColourDialog.this.listener != null) {
						ColourDialog.this.listener.onCancel(ColourDialog.this);
					}
				}
			})
