package com.example.drawfriends.widget;
...
public class ColourPreference extends Preference {
	...
	@Override protected void onClick() {
		new ColourDialog(getContext(), value, new ColourDialog.OnColourListener() {
			@Override public void onOk(ColourDialog dialog, int color) {
			...
			@Override public void onCancel(ColourDialog dialog) {
				// nothing to do
			}
		}).show();
	}
